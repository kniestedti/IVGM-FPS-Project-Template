Key Door System - Version 1.0.1
=============================


   * Hi there!
   * Here is a really interesting System to add to your games!
   * This System allows you to place Keys in your Levels, pick them up with your Player and Open Doors with specific Keys.
   * 
   * Video Tutorial - Learn how the Code Works
   ...
   * Check out my other Assets, the <b>Free Health System</b> and the <b>Mouse Cursor System PRO!</b>
   * Hope you find them useful and best of luck with your games!
   * - Code Monkey
   * https://youtube.com/c/CodeMonkeyUnity
   *
   * 
   * FREE Health System
   * https://unitycodemonkey.com/video.php?v=tf8NhUgORQg
   * 
   * Mouse Cursor System PRO
   * https://unitycodemonkey.com/video.php?v=wI7ug-6hdcM
   * 
   * 
...
---------
## [1.0.1] - 2022-10-19
- Fixed errors when not used alongside the FPS Microgame
